...
def generate_event_flyer(venue_name: str, guest_count: int, event_theme: str) -> str:
    ...
    Call exactly once per venue. Once you receive a successful image URL,
    report it to the user — do not retry or generate additional flyers.
    ...
    try:
        ...
        return json.dumps({
            ...
            "note": "Flyer generated. Present the image URL to the user. Do not generate another flyer.",
        })
